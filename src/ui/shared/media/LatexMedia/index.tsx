...
import { LatexDocumentViewer } from '@/ui/shared/primitives/LatexDocumentViewer'
...
export const LatexMedia: React.FC<MediaProps> = (props) => {
  ...
  if (error) {
    return (
      <div
        className={cn(
          'flex items-center justify-center p-card-padding-lg text-muted-foreground',
          className,
        )}
      >
  ...
  if (!latex) {
    return (
      <div className={cn('flex items-center justify-center p-card-padding-lg', className)}>
