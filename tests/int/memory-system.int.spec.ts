...
// Live memory coverage calls external AI and vector services, so keep it opt-in.
const hasOpenAIKey = !!process.env.OPENAI_API_KEY
const liveMemorySystemEnabled = process.env.MEMORY_SYSTEM_LIVE_TESTS === '1'

describe.skipIf(!liveMemorySystemEnabled || !hasOpenAIKey)(
