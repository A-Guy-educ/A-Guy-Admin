  ...
  describe('VercelBlobAdapter Integration', () => {
    ...
    describe('List and Exists', () => {
      it('should list uploaded files', async () => {
        ...
        const testBlob = result.blobs.find((b: BlobListResult['blobs'][number]) =>
          b.pathname.includes(testId),
        )
      ...
      it('should check if file exists', async () => {
        ...
        const listResult = await adapter.list('integration-tests')
        const testBlob = listResult.blobs.find((b: BlobListResult['blobs'][number]) =>
          b.pathname.includes(testId),
        )
